...
class Booking(models.Model):
    ...
    user_name = models.CharField(max_length=150, help_text=_('Guest full name'))
    user_email = models.EmailField(db_index=True, help_text=_('Guest email used for OTP access'))
